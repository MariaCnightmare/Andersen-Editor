  ...
  const template = [
      ...
      : []),
    {
      ...
      submenu: [
        ...
        { type: "separator" },
        { label: "SVGを書き出し…", click: () => sendAction(win, "file:exportSvg") },
        { label: "Mermaidを書き出し…", click: () => sendAction(win, "file:exportMermaid") },
        { label: "PNGを書き出し…", click: () => sendAction(win, "file:exportPng") },
        { label: "PDFを書き出し…", click: () => sendAction(win, "file:exportPdf") },
        {
    ...
    },
    {
      label: "編集",
      submenu: [
        { label: "取り消し", id: "edit.undo", click: () => sendAction(win, "edit:undo") },
        { label: "やり直し", id: "edit.redo", click: () => sendAction(win, "edit:redo") },
        { type: "separator" },
        {
          label: "Mermaid整形",
    ...
    },
    {
      label: "ヘルプ",
      submenu: [
        { label: "Copy Diagnostics", click: () => sendAction(win, "help:copyDiagnostics") },
        {
          label: "プロジェクトページを開く",
          click: async () => {
